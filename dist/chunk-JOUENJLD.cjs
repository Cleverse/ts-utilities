...
var _chunk7AKSGM4Rcjs = require('./chunk-7AKSGM4R.cjs');


var _chunkOOVTCTM3cjs = require('./chunk-OOVTCTM3.cjs');
...
var FileHelper = class _FileHelper {
    ...
    try {
      ...
      switch (url.protocol) {
        ...
        case "onedrive:": {
          ...
          driveId = _chunk7AKSGM4Rcjs.OneDriveService.formatDriveId(driveId);
          itemId = _chunk7AKSGM4Rcjs.OneDriveService.formatItemId(itemId);
          return {
            type: "onedrive",
        ...
        case "sharepoint:": {
          ...
          const driveId = _chunk7AKSGM4Rcjs.OneDriveService.formatDriveId(_nullishCoalesce(pathParts[0], () => ( "")));
          const itemId = _chunk7AKSGM4Rcjs.OneDriveService.formatItemId(_nullishCoalesce(pathParts[1], () => ( "")));
          return {
            type: "sharepoint",
        ...
        case "http:":
        case "https:": {
          if (_chunkOOVTCTM3cjs.CloudStorageService.isGCSUrl(fileUrl)) {
            const info = _chunkOOVTCTM3cjs.CloudStorageService.extractInfo(fileUrl);
            if (!info) {
              throw new (0, _verror.VError)(`Invalid GCS URL format, expecting 'gs://{bucketName}/{filePath}'`);
            }
            return {
              type: "gcs",
              uri: _chunkOOVTCTM3cjs.CloudStorageService.toGCSUri(info),
  ...
  static encodeUri(fileUri) {
    switch (fileUri.type) {
      ...
      case "onedrive":
        return `onedrive://${_chunk7AKSGM4Rcjs.OneDriveService.formatDriveId(fileUri.driveId)}/${_chunk7AKSGM4Rcjs.OneDriveService.formatItemId(fileUri.itemId)}`;
      case "sharepoint":
        return `sharepoint://${fileUri.siteId}/${_chunk7AKSGM4Rcjs.OneDriveService.formatDriveId(fileUri.driveId)}/${_chunk7AKSGM4Rcjs.OneDriveService.formatItemId(fileUri.itemId)}`;
      case "public":
        return fileUri.uri;
      default:
...
//# sourceMappingURL=chunk-JOUENJLD.cjs.map