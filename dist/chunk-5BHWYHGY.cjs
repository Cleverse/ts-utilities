...
var require_branding = _chunkT6TWWATEcjs.__commonJS.call(void 0, {
...
var require_messages = _chunkT6TWWATEcjs.__commonJS.call(void 0, {
...
var require_overloads = _chunkT6TWWATEcjs.__commonJS.call(void 0, {
...
var require_utils = _chunkT6TWWATEcjs.__commonJS.call(void 0, {
...
var require_dist = _chunkT6TWWATEcjs.__commonJS.call(void 0, {
...
// node_modules/.pnpm/@vitest+runner@4.0.16/node_modules/@vitest/runner/dist/index.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/error.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/diff.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+pretty-format@4.0.16/node_modules/@vitest/pretty-format/dist/index.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
var test$3 = (val) => _optionalChain([val, 'optionalAccess', _2 => _2.constructor, 'optionalAccess', _3 => _3.name]) && testNode(val);
...
function getPrintFunctionName(options) {
  return _nullishCoalesce(_optionalChain([options, 'optionalAccess', _4 => _4.printFunctionName]), () => ( DEFAULT_OPTIONS.printFunctionName));
}
function getEscapeRegex(options) {
  return _nullishCoalesce(_optionalChain([options, 'optionalAccess', _5 => _5.escapeRegex]), () => ( DEFAULT_OPTIONS.escapeRegex));
}
function getEscapeString(options) {
  return _nullishCoalesce(_optionalChain([options, 'optionalAccess', _6 => _6.escapeString]), () => ( DEFAULT_OPTIONS.escapeString));
}
function getConfig(options) {
  return {
    callToJSON: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _7 => _7.callToJSON]), () => ( DEFAULT_OPTIONS.callToJSON)),
    colors: _optionalChain([options, 'optionalAccess', _8 => _8.highlight]) ? getColorsHighlight() : getColorsEmpty(),
    compareKeys: typeof _optionalChain([options, 'optionalAccess', _9 => _9.compareKeys]) === "function" || _optionalChain([options, 'optionalAccess', _10 => _10.compareKeys]) === null ? options.compareKeys : DEFAULT_OPTIONS.compareKeys,
    escapeRegex: getEscapeRegex(options),
    escapeString: getEscapeString(options),
    indent: _optionalChain([options, 'optionalAccess', _11 => _11.min]) ? "" : createIndent(_nullishCoalesce(_optionalChain([options, 'optionalAccess', _12 => _12.indent]), () => ( DEFAULT_OPTIONS.indent))),
    maxDepth: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _13 => _13.maxDepth]), () => ( DEFAULT_OPTIONS.maxDepth)),
    maxWidth: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _14 => _14.maxWidth]), () => ( DEFAULT_OPTIONS.maxWidth)),
    min: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _15 => _15.min]), () => ( DEFAULT_OPTIONS.min)),
    plugins: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _16 => _16.plugins]), () => ( DEFAULT_OPTIONS.plugins)),
    printBasicPrototype: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _17 => _17.printBasicPrototype]), () => ( true)),
    printFunctionName: getPrintFunctionName(options),
    printShadowRoot: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _18 => _18.printShadowRoot]), () => ( true)),
    spacingInner: _optionalChain([options, 'optionalAccess', _19 => _19.min]) ? " " : "\n",
    spacingOuter: _optionalChain([options, 'optionalAccess', _20 => _20.min]) ? "" : "\n"
  };
}
...
// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/display.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
var ansiColors = {
  bold: ["1", "22"],
  dim: ["2", "22"],
...
function stringify(object2, maxDepth = 10, { maxLength, ...options } = {}) {
  const MAX_LENGTH = _nullishCoalesce(maxLength, () => ( 1e4));
  let result;
  try {
...
// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/helpers.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/chunk-_commonjsHelpers.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
function diffLinesRaw(aLines, bLines, options) {
  const truncate3 = _nullishCoalesce((options === null || options === void 0 ? void 0 : options.truncateThreshold), () => ( false));
  const truncateThreshold = Math.max(Math.floor(_nullishCoalesce((options === null || options === void 0 ? void 0 : options.truncateThreshold), () => ( 0))), 0);
...
function getFormatOptions(formatOptions, options) {
  ...
  return {
    ...
    compareKeys,
    printBasicPrototype,
    maxDepth: _nullishCoalesce(maxDepth, () => ( formatOptions.maxDepth))
  };
}
...
// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/serialize.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
  ...
  if (val instanceof Error && "toJSON" in val && typeof val.toJSON === "function") {
    ...
    if (jsonValue && jsonValue !== val && typeof jsonValue === "object") {
      if (typeof val.message === "string") {
        safe(() => _nullishCoalesce(jsonValue.message, () => ( (jsonValue.message = normalizeErrorMessage(val.message)))));
      }
      if (typeof val.stack === "string") {
        safe(() => _nullishCoalesce(jsonValue.stack, () => ( (jsonValue.stack = val.stack))));
      }
      if (typeof val.name === "string") {
        safe(() => _nullishCoalesce(jsonValue.name, () => ( (jsonValue.name = val.name))));
      }
      if (val.cause != null) {
        safe(() => _nullishCoalesce(jsonValue.cause, () => ( (jsonValue.cause = serializeValue(val.cause, seen)))));
      }
    }
...
// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/timers.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
// node_modules/.pnpm/@vitest+runner@4.0.16/node_modules/@vitest/runner/dist/chunk-tasks.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/source-map.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+utils@4.0.16/node_modules/@vitest/utils/dist/chunk-pathe.M-eThtNZ.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
// node_modules/.pnpm/@vitest+runner@4.0.16/node_modules/@vitest/runner/dist/index.js
var PendingError = (_class = class extends Error {
  __init() {this.code = "VITEST_PENDING"}
...
function mergeContextFixtures(fixtures, context, runner2) {
  ...
  const fixtureArray = Object.entries(fixtures).map(([prop, value]) => {
    ...
    if (Array.isArray(value) && value.length >= 2 && isObject(value[1]) && Object.keys(value[1]).some((key) => fixtureOptionKeys.includes(key))) {
      ...
      fixtureItem.value = fixtureItem.injected ? _nullishCoalesce(((_runner$injectValue = runner2.injectValue) === null || _runner$injectValue === void 0 ? void 0 : _runner$injectValue.call(runner2, prop)), () => ( userValue)) : userValue;
    }
...
function resolveFixtureValue(runner2, fixture, context, cleanupFnArray) {
  ...
  if (!fixture.isFn) {
    var _fixture$prop;
    _nullishCoalesce(fileContext[_fixture$prop = fixture.prop], () => ( (fileContext[_fixture$prop] = fixture.value)));
    if (workerContext) {
      var _fixture$prop2;
      _nullishCoalesce(workerContext[_fixture$prop2 = fixture.prop], () => ( (workerContext[_fixture$prop2] = fixture.value)));
    }
...
function afterAll(fn2, timeout) {
  ...
  return getCurrentSuite().on("afterAll", withTimeout(fn2, _nullishCoalesce(timeout, () => ( getDefaultHookTimeout())), true, new Error("STACK_TRACE_ERROR")));
}
function beforeEach(fn2, timeout = getDefaultHookTimeout()) {
  assertTypes(fn2, '"beforeEach" callback', ["function"]);
  const stackTraceError = new Error("STACK_TRACE_ERROR");
  const runner2 = getRunner();
  return getCurrentSuite().on("beforeEach", Object.assign(withTimeout(withFixtures(runner2, fn2), _nullishCoalesce(timeout, () => ( getDefaultHookTimeout())), true, stackTraceError, abortIfTimeout), {
    [CLEANUP_TIMEOUT_KEY]: timeout,
    [CLEANUP_STACK_TRACE_KEY]: stackTraceError
  }));
}
function afterEach(fn2, timeout) {
  ...
  const runner2 = getRunner();
  return getCurrentSuite().on("afterEach", withTimeout(withFixtures(runner2, fn2), _nullishCoalesce(timeout, () => ( getDefaultHookTimeout())), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
}
var onTestFailed = createTestHook("onTestFailed", (test5, handler, timeout) => {
  test5.onFailed || (test5.onFailed = []);
  test5.onFailed.push(withTimeout(handler, _nullishCoalesce(timeout, () => ( getDefaultHookTimeout())), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
});
var onTestFinished = createTestHook("onTestFinished", (test5, handler, timeout) => {
  test5.onFinished || (test5.onFinished = []);
  test5.onFinished.push(withTimeout(handler, _nullishCoalesce(timeout, () => ( getDefaultHookTimeout())), true, new Error("STACK_TRACE_ERROR"), abortIfTimeout));
});
...
function createSuiteCollector(name, factory = () => {
  ...
  const task = function(name2 = "", options = {}) {
    ...
    const timeout = _nullishCoalesce((options === null || options === void 0 ? void 0 : options.timeout), () => ( runner.config.testTimeout));
    ...
    const task2 = {
      id: "",
      name: name2,
      fullName: createTaskName([_nullishCoalesce((currentSuite === null || currentSuite === void 0 ? void 0 : currentSuite.fullName), () => ( ((_collectorContext$cur2 = collectorContext.currentSuite) === null || _collectorContext$cur2 === void 0 || (_collectorContext$cur2 = _collectorContext$cur2.file) === null || _collectorContext$cur2 === void 0 ? void 0 : _collectorContext$cur2.fullName))), name2]),
      ...
      context: void 0,
      type: "test",
      file: _nullishCoalesce((currentSuite === null || currentSuite === void 0 ? void 0 : currentSuite.file), () => ( ((_collectorContext$cur3 = collectorContext.currentSuite) === null || _collectorContext$cur3 === void 0 ? void 0 : _collectorContext$cur3.file))),
      timeout,
      retry: _nullishCoalesce(options.retry, () => ( runner.config.retry)),
      repeats: options.repeats,
      mode: options.only ? "only" : options.skip ? "skip" : options.todo ? "todo" : "run",
      meta: _nullishCoalesce(options.meta, () => ( /* @__PURE__ */ Object.create(null))),
      annotations: [],
      artifacts: []
    };
  ...
  function initSuite(includeLocation) {
    ...
    suite2 = {
      ...
      type: "suite",
      name,
      fullName: createTaskName([_nullishCoalesce((currentSuite === null || currentSuite === void 0 ? void 0 : currentSuite.fullName), () => ( ((_collectorContext$cur5 = collectorContext.currentSuite) === null || _collectorContext$cur5 === void 0 || (_collectorContext$cur5 = _collectorContext$cur5.file) === null || _collectorContext$cur5 === void 0 ? void 0 : _collectorContext$cur5.fullName))), name]),
      fullTestName: createTaskName([currentSuite === null || currentSuite === void 0 ? void 0 : currentSuite.fullTestName, name]),
      suite: currentSuite,
      mode,
      each,
      file: _nullishCoalesce((currentSuite === null || currentSuite === void 0 ? void 0 : currentSuite.file), () => ( ((_collectorContext$cur6 = collectorContext.currentSuite) === null || _collectorContext$cur6 === void 0 ? void 0 : _collectorContext$cur6.file))),
...
function createSuite() {
  function suiteFn(name, factoryOrOptions, optionsOrFactory) {
    ...
    options = {
      ...
      ...options,
      shuffle: _nullishCoalesce(_nullishCoalesce(_nullishCoalesce(this.shuffle, () => ( options.shuffle)), () => ( (currentSuite === null || currentSuite === void 0 || (_currentSuite$options = currentSuite.options) === null || _currentSuite$options === void 0 ? void 0 : _currentSuite$options.shuffle))), () => ( (runner === null || runner === void 0 ? void 0 : runner.config.sequence.shuffle)))
    };
...
function createTestContext(test5, runner2) {
  ...
  context.skip = (condition, note) => {
    ...
    _nullishCoalesce(test5.result, () => ( (test5.result = { state: "skip" })));
  ...
  context.onTestFailed = (handler, timeout) => {
    test5.onFailed || (test5.onFailed = []);
    test5.onFailed.push(withTimeout(handler, _nullishCoalesce(timeout, () => ( runner2.config.hookTimeout)), true, new Error("STACK_TRACE_ERROR"), (_, error) => abortController.abort(error)));
  };
  context.onTestFinished = (handler, timeout) => {
    test5.onFinished || (test5.onFinished = []);
    test5.onFinished.push(withTimeout(handler, _nullishCoalesce(timeout, () => ( runner2.config.hookTimeout)), true, new Error("STACK_TRACE_ERROR"), (_, error) => abortController.abort(error)));
  };
...
function throttle(fn2, ms) {
  ...
  return function call2(...args) {
    ...
    _nullishCoalesce(pendingCall, () => ( (pendingCall = setTimeout2(() => call2.bind(this)(...args), ms))));
  };
}
...
// node_modules/.pnpm/vitest@4.0.16_@types+node@25.0.3_yaml@2.8.2/node_modules/vitest/dist/chunks/vi.2VT5v0um.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+expect@4.0.16/node_modules/@vitest/expect/dist/index.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+spy@4.0.16/node_modules/@vitest/spy/dist/index.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
function createMockInstance(options = {}) {
  ...
  const mockLength = _nullishCoalesce(((_ref = mockImplementation || originalImplementation) === null || _ref === void 0 ? void 0 : _ref.length), () => ( 0));
...
var chai_exports = {};
_chunkT6TWWATEcjs.__export.call(void 0, chai_exports, {
  Assertion: () => Assertion,
...
var AsymmetricMatcher3 = (_class2 = class {
  // should have "jest" to be compatible with its ecosystem
  __init2() {this.$$typeof = /* @__PURE__ */ Symbol.for("jest.asymmetricMatcher")}
  constructor(sample, inverse = false) {;_class2.prototype.__init2.call(this);
    this.sample = sample;
...
var ObjectContaining = class extends AsymmetricMatcher3 {
  ...
  asymmetricMatch(other, customTesters) {
    ...
    for (const property of properties) {
      ...
      const value = _nullishCoalesce(((_Object$getOwnPropert2 = Object.getOwnPropertyDescriptor(this.sample, property)) === null || _Object$getOwnPropert2 === void 0 ? void 0 : _Object$getOwnPropert2.value), () => ( this.sample[property]));
      const otherValue = _nullishCoalesce(((_Object$getOwnPropert3 = Object.getOwnPropertyDescriptor(other, property)) === null || _Object$getOwnPropert3 === void 0 ? void 0 : _Object$getOwnPropert3.value), () => ( other[property]));
...
function recordAsyncExpect(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    test5.promises.push(promise);
    let resolved = false;
    _nullishCoalesce(test5.onFinished, () => ( (test5.onFinished = [])));
...
function getMatcherState(assertion, expect2) {
  ...
  const currentTestName = _nullishCoalesce((task === null || task === void 0 ? void 0 : task.fullTestName), () => ( ""));
...
// node_modules/.pnpm/vitest@4.0.16_@types+node@25.0.3_yaml@2.8.2/node_modules/vitest/dist/chunks/utils.DvEY5TfP.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
// node_modules/.pnpm/@vitest+runner@4.0.16/node_modules/@vitest/runner/dist/utils.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/@vitest+snapshot@4.0.16/node_modules/@vitest/snapshot/dist/index.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
var DecodedMap = (_class3 = class {
  ...
  constructor(map2, from) {;_class3.prototype.__init3.call(this);
    this.map = map2;
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await Promise.resolve().then(() => _interopRequireWildcard(require("./magic-string.es-YUSIU2LD.cjs")))).default;
...
var SnapshotState = (_class4 = class _SnapshotState {
  __init4() {this._counters = new CounterMap()}
  ...
  __init5() {this._testIdToKeys = new DefaultMap(() => [])}
  ...
  __init6() {this._added = new CounterMap()}
  __init7() {this._matched = new CounterMap()}
  __init8() {this._unmatched = new CounterMap()}
  __init9() {this._updated = new CounterMap()}
  get added() {
    return this._added;
  }
  set added(value) {
  ...
  constructor(testFilePath, snapshotPath, snapshotContent, options) {;_class4.prototype.__init4.call(this);_class4.prototype.__init5.call(this);_class4.prototype.__init6.call(this);_class4.prototype.__init7.call(this);_class4.prototype.__init8.call(this);_class4.prototype.__init9.call(this);
...
var SnapshotClient = (_class5 = class {
  __init10() {this.snapshotStateMap = /* @__PURE__ */ new Map()}
  ...
  assert(options) {
    ...
    if (typeof properties === "object") {
      ...
      try {
        ...
        const pass2 = _nullishCoalesce(((_this$options$isEqual = (_this$options = this.options).isEqual) === null || _this$options$isEqual === void 0 ? void 0 : _this$options$isEqual.call(_this$options, received, properties)), () => ( false));
        if (!pass2) {
  ...
  async assertRaw(options) {
    ...
    if (rawSnapshot.content == null) {
      ...
      rawSnapshot.content = await _asyncNullishCoalesce(await snapshotState.environment.readSnapshotFile(rawSnapshot.file), async () => ( void 0));
    }
...
// node_modules/.pnpm/vitest@4.0.16_@types+node@25.0.3_yaml@2.8.2/node_modules/vitest/dist/chunks/_commonjsHelpers.D26ty3Ew.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
var commonjsGlobal = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};

// node_modules/.pnpm/vitest@4.0.16_@types+node@25.0.3_yaml@2.8.2/node_modules/vitest/dist/chunks/date.Bq6ZW5rf.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
var RealDate = Date;
var now2 = null;
...
function createExpectPoll(expect2) {
  return function poll(fn2, options = {}) {
    const defaults = _nullishCoalesce(_optionalChain([getWorkerState, 'call', _21 => _21(), 'access', _22 => _22.config, 'access', _23 => _23.expect, 'optionalAccess', _24 => _24.poll]), () => ( {}));
    const { interval = _nullishCoalesce(defaults.interval, () => ( 50)), timeout = _nullishCoalesce(defaults.timeout, () => ( 1e3)), message } = options;
...
function recordAsyncExpect2(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    test5.onFinished.push(() => {
      if (!resolved) {
        const stack = (_optionalChain([globalThis, 'access', _25 => _25.__vitest_worker__, 'optionalAccess', _26 => _26.onFilterStackTrace]) || ((s) => s || ""))(error.stack);
        console.warn([
          `Promise returned by \`${assertion}\` was not awaited. `,
          "Vitest currently auto-awaits hanging assertions at the end of the test, but this will cause the test to fail in Vitest 3. ",
          "Please remember to await the assertion.\n",
...
var SnapshotPlugin = (chai, utils) => {
  ...
  utils.addMethod(chai.Assertion.prototype, "toMatchInlineSnapshot", function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
    ...
    if (test5.each || _optionalChain([test5, 'access', _27 => _27.suite, 'optionalAccess', _28 => _28.each])) throw new Error("InlineSnapshot cannot be used inside of test.each or describe.each");
    const expected = utils.flag(this, "object");
  ...
  utils.addMethod(chai.Assertion.prototype, "toThrowErrorMatchingInlineSnapshot", function __INLINE_SNAPSHOT__(inlineSnapshot, message) {
    ...
    if (test5.each || _optionalChain([test5, 'access', _29 => _29.suite, 'optionalAccess', _30 => _30.each])) throw new Error("InlineSnapshot cannot be used inside of test.each or describe.each");
    const expected = utils.flag(this, "object");
    const error = utils.flag(this, "error");
    const promise = utils.flag(this, "promise");
    const errorMessage = utils.flag(this, "message");
...
function createExpect(test5) {
  ...
  setState({
    ...
    currentTestName: test5 ? _nullishCoalesce(test5.fullTestName, () => ( "")) : globalState.currentTestName
  }, expect2);
          ...
          if (nameOfMethodToReplace === "setTimeout") {
            ...
            timersPromisesModule.setInterval = (delay2, value, options = {}) => ({
              [Symbol.asyncIterator]: () => {
                ...
                return {
                  next: async () => {
                    if (_optionalChain([options, 'access', _31 => _31.signal, 'optionalAccess', _32 => _32.aborted]) && !hasThrown) {
                      hasThrown = true;
                    ...
                    if (_optionalChain([options, 'access', _33 => _33.signal, 'optionalAccess', _34 => _34.aborted]) && !hasThrown) {
                      hasThrown = true;
                      throw options.signal.reason;
                    }
                    if (done) {
...
var FakeTimers = (_class6 = class {
  ...
  __init11() {this._now = RealDate.now}
  constructor({ global: global3, config: config2 }) {;_class6.prototype.__init11.call(this);
  ...
  useFakeTimers() {
    ...
    if (_optionalChain([this, 'access', _35 => _35._userConfig, 'optionalAccess', _36 => _36.toFake, 'optionalAccess', _37 => _37.includes, 'call', _38 => _38("nextTick")]) && isChildProcess()) throw new Error("process.nextTick cannot be mocked inside child_process");
    this._clock = this._fakeTimers.install({
      now: fakeDate,
      ...this._userConfig,
      toFake: _optionalChain([this, 'access', _39 => _39._userConfig, 'optionalAccess', _40 => _40.toFake]) || toFake,
  ...
  setSystemTime(now3) {
    ...
    if (this._fakingTime) this._clock.setSystemTime(date);
      ...
      this._fakingDate = _nullishCoalesce(date, () => ( new Date(this.getRealSystemTime())));
...
function createVitest() {
  ...
  const utils = {
    useFakeTimers(config2) {
      if (isChildProcess()) {
        if (_optionalChain([config2, 'optionalAccess', _41 => _41.toFake, 'optionalAccess', _42 => _42.includes, 'call', _43 => _43("nextTick")]) || _optionalChain([state, 'call', _44 => _44(), 'access', _45 => _45.config, 'optionalAccess', _46 => _46.fakeTimers, 'optionalAccess', _47 => _47.toFake, 'optionalAccess', _48 => _48.includes, 'call', _49 => _49("nextTick")])) throw new Error('vi.useFakeTimers({ toFake: ["nextTick"] }) is not supported in node:child_process. Use --pool=threads if mocking nextTick is required.');
      }
    ...
    mockObject(value, options) {
      return _mocker().mockObject({ value }, void 0, _optionalChain([options, 'optionalAccess', _50 => _50.spy]) ? "autospy" : "automock").value;
    },
...
function getImporter(name) {
  ...
  return _optionalChain([parseSingleStack, 'call', _51 => _51(stackArray[stackArray.findLastIndex((stack) => {
    return stack.includes(` at Object.${name}`) || stack.includes(`${name}@`) || stack.includes(` at ${name} (`);
  }) + 1]), 'optionalAccess', _52 => _52.file]) || "";
}

// node_modules/.pnpm/vitest@4.0.16_@types+node@25.0.3_yaml@2.8.2/node_modules/vitest/dist/index.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );

// node_modules/.pnpm/vite@7.3.0_@types+node@25.0.3_yaml@2.8.2/node_modules/vite/dist/node/module-runner.js
_chunkT6TWWATEcjs.init_cjs_shims.call(void 0, );
...
// node_modules/.pnpm/vitest@4.0.16_@types+node@25.0.3_yaml@2.8.2/node_modules/vitest/dist/index.js
var import_expect_type = _chunkT6TWWATEcjs.__toESM.call(void 0, require_dist(), 1);
...
exports.beforeEach = beforeEach; exports.afterEach = afterEach; exports.describe = describe; exports.it = it; exports.globalExpect = globalExpect; exports.vi = vi;
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5BHWYHGY.cjs.map