...
var CustomError = class _CustomError extends _verror2.default {
    ...
    super(
      {
        ...
        info: _nullishCoalesce(_optionalChain([options, 'optionalAccess', _2 => _2.info]), () => ( {}))
      },
      message
    );
    this.statusCode = _nullishCoalesce(_optionalChain([options, 'optionalAccess', _3 => _3.statusCode]), () => ( 500));
    this.publicInfo = _nullishCoalesce(_optionalChain([options, 'optionalAccess', _4 => _4.publicInfo]), () => ( {}));
  }
  /**
  ...
  static info(error) {
    return _nullishCoalesce(_verror2.default.info(_chunkRWHWC4QPcjs.errors.toError(error)), () => ( {}));
  }
  static cause(error) {
    return _nullishCoalesce(_chunkRWHWC4QPcjs.errors.unwrap(error), () => ( null));
  }
};
...
//# sourceMappingURL=chunk-DDH27FXX.cjs.map