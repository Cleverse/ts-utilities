"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } var _class;require('../chunk-XKCUFI4V.cjs');
...
var defaultLoggerOptions = loggerOptions[_nullishCoalesce(environment, () => ( "local"))];
var PinoAdapter = (_class = class _PinoAdapter {
  constructor(logger2) {
    this.logger = logger2;
  }
  // Global default logger
  static __initStatic() {this._logger = new _PinoAdapter(_pino2.default.call(void 0, defaultLoggerOptions))}
  static get logger() {
