    ...
    try {
      await pipeline(
        ...
        file.createWriteStream({
          ...options,
          resumable: false,
          contentType: response.headers.get("content-type") ?? options?.contentType ?? void 0,
          metadata: {
            ...options?.metadata,
      ...
      return {
        ...
        checksumCrc32c: metadata.crc32c,
        checksumMd5: metadata.md5Hash,
        contentType: metadata.contentType ?? response.headers.get("content-type") ?? options?.contentType ?? "application/octet-stream",
        bucketName,
        filePath
      };
    } catch (error) {
...
//# sourceMappingURL=chunk-BX6IQ5WF.js.map