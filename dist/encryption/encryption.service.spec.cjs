...
var mockEncrypt = _chunk5BHWYHGYcjs.vi.mocked(_chunkXRCCUYOXcjs.EncryptionModule.encrypt);
var mockDecrypt = _chunk5BHWYHGYcjs.vi.mocked(_chunkXRCCUYOXcjs.EncryptionModule.decrypt);
var mockGenerateEncryptionKey = _chunk5BHWYHGYcjs.vi.mocked(_chunkXRCCUYOXcjs.EncryptionModule.generateEncryptionKey);
...
_chunk5BHWYHGYcjs.describe.call(void 0, "EnvelopeEncryptionService", () => {
  ...
  _chunk5BHWYHGYcjs.beforeEach.call(void 0, () => {
    ...
    config = {};
    service = new (0, _chunkXRCCUYOXcjs.EnvelopeEncryptionService)(mockKMSClient, mockSharedDEKDatagateway, config);
  });
  _chunk5BHWYHGYcjs.describe.call(void 0, "encrypt", () => {
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should encrypt data with specified DEK version", async () => {
      ...
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, _chunkXRCCUYOXcjs.EncryptionModule.encrypt).toHaveBeenCalledWith(testData, dek.dek, testNonce);
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should use generated nonce when not provided", async () => {
      ...
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, _chunkXRCCUYOXcjs.EncryptionModule.encrypt).toHaveBeenCalledWith(testData, dek.dek, void 0);
  ...
  _chunk5BHWYHGYcjs.describe.call(void 0, "decrypt", () => {
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should decrypt data successfully", async () => {
      ...
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, mockSharedDEKDatagateway.getDEK).toHaveBeenCalledWith(1);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, mockKMSDecrypt).toHaveBeenCalledWith("encrypted-dek", "1");
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, _chunkXRCCUYOXcjs.EncryptionModule.decrypt).toHaveBeenCalledWith(ciphertext, nonce, dek.dek);
  ...
  _chunk5BHWYHGYcjs.describe.call(void 0, "rotateDEK", () => {
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should rotate DEK successfully", async () => {
      ...
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, _chunkXRCCUYOXcjs.EncryptionModule.generateEncryptionKey).toHaveBeenCalledWith("hex");
