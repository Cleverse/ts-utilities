...
_chunk5BHWYHGYcjs.describe.call(void 0, "EncryptionModule", () => {
  ...
  _chunk5BHWYHGYcjs.describe.call(void 0, "aesGcmEncrypt", () => {
    _chunk5BHWYHGYcjs.it.call(void 0, "should encrypt data correctly and return ciphertext and nonce", async () => {
      const result = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, validKey);
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should use provided nonce if given", async () => {
      ...
      const result = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, validKey, nonce);
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should throw error if key length is invalid", async () => {
      await _chunk5BHWYHGYcjs.globalExpect.call(void 0, _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, "invalid-length")).rejects.toThrow(
  ...
  _chunk5BHWYHGYcjs.describe.call(void 0, "aesGcmDecrypt", () => {
    _chunk5BHWYHGYcjs.it.call(void 0, "should decrypt data correctly", async () => {
      const { ciphertext, nonce } = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, validKey);
      const decrypted = await _chunkAQ2YAQ2Ecjs.EncryptionModule.decrypt(ciphertext, nonce, validKey);
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should throw error if key length is invalid", async () => {
      const { ciphertext, nonce } = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, validKey);
      await _chunk5BHWYHGYcjs.globalExpect.call(void 0, _chunkAQ2YAQ2Ecjs.EncryptionModule.decrypt(ciphertext, nonce, "invalid-length")).rejects.toThrow(
        "Encryption key must be exactly 32 bytes for AES-256"
      );
    });
    _chunk5BHWYHGYcjs.it.call(void 0, "should fail to decrypt with wrong key", async () => {
      ...
      await _chunk5BHWYHGYcjs.globalExpect.call(void 0, _chunkAQ2YAQ2Ecjs.EncryptionModule.decrypt(ciphertext, nonce, wrongKey)).rejects.toThrow("Failed to decrypt data");
    });
  });
  _chunk5BHWYHGYcjs.describe.call(void 0, "generateEncryptionKey", () => {
    _chunk5BHWYHGYcjs.it.call(void 0, "should generate a 64-character hex key by default (32 bytes)", () => {
      const key = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey();
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should generate a 64-character hex key when specified", () => {
      const key = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey("hex");
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, typeof key).toBe("string");
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, key.length).toBe(64);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, /^[0-9a-fA-F]+$/.test(key)).toBe(true);
    });
    _chunk5BHWYHGYcjs.it.call(void 0, "should generate a 44-character base64 key (32 bytes)", () => {
      const key = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey("base64");
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, typeof key).toBe("string");
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should generate a 32-character ascii key (32 bytes)", () => {
      const key = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey("ascii");
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, typeof key).toBe("string");
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should generate a 32-character utf8 key (legacy fallback)", () => {
      const key = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey("utf8");
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, typeof key).toBe("string");
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, key.length).toBe(32);
    });
    _chunk5BHWYHGYcjs.it.call(void 0, "should generate different keys on subsequent calls", () => {
      const key1 = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey();
      const key2 = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey();
    ...
    _chunk5BHWYHGYcjs.it.each(["hex", "base64", "ascii", "utf8"])(
      ...
      async (encoding) => {
        const key = _chunkAQ2YAQ2Ecjs.EncryptionModule.generateEncryptionKey(encoding);
        const data2 = new Uint8Array(Buffer.from("hello world"));
        const result = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data2, key);
        _chunk5BHWYHGYcjs.globalExpect.call(void 0, result.ciphertext).toBeDefined();
        const decrypted = await _chunkAQ2YAQ2Ecjs.EncryptionModule.decrypt(result.ciphertext, result.nonce, key);
  ...
  _chunk5BHWYHGYcjs.describe.call(void 0, "Key Formats", () => {
    ...
    _chunk5BHWYHGYcjs.it.call(void 0, "should support hex encoded key (64 chars)", async () => {
      const result = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, hexKey);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, result.ciphertext).toBeDefined();
      const decrypted = await _chunkAQ2YAQ2Ecjs.EncryptionModule.decrypt(result.ciphertext, result.nonce, hexKey);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, decrypted).toEqual(data);
    });
    _chunk5BHWYHGYcjs.it.call(void 0, "should support base64 encoded key (44 chars)", async () => {
      const result = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, base64Key);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, result.ciphertext).toBeDefined();
      const decrypted = await _chunkAQ2YAQ2Ecjs.EncryptionModule.decrypt(result.ciphertext, result.nonce, base64Key);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, decrypted).toEqual(data);
    });
    _chunk5BHWYHGYcjs.it.call(void 0, "should support utf8 key (32 chars)", async () => {
      const result = await _chunkAQ2YAQ2Ecjs.EncryptionModule.encrypt(data, utf8Key);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, result.ciphertext).toBeDefined();
      const decrypted = await _chunkAQ2YAQ2Ecjs.EncryptionModule.decrypt(result.ciphertext, result.nonce, utf8Key);
      _chunk5BHWYHGYcjs.globalExpect.call(void 0, decrypted).toEqual(data);
    });
  });
});
